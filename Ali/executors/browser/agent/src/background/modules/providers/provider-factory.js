...
import { CactusProvider } from './cactus-provider.js';

// List of all available providers. Cactus first so it wins on URL match
// (its localhost:8765 endpoint can otherwise look OpenAI-compatible).
const PROVIDERS = [
  CactusProvider,
  AnthropicProvider,
  OpenAIProvider,
