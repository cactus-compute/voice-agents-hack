...
// Default config — overridden by chrome.storage.local at loadConfig() time.
// Browser execution uses Google AI Studio (gemini-2.5-flash). On-device Cactus
// stays in seat 1 (intent parser) per the project's privacy story; the
// browser-side cloud call is the user-consent surface (await_confirmation).
let config = {
  apiBaseUrl: 'https://generativelanguage.googleapis.com/v1beta/models',
  apiKey: null,  // user supplies via storage; see service-worker boot pin
